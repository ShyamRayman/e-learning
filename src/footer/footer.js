...
function Footer() {
  return (
    <div className="FooterParent container-fluid  text-dark">
      {/* Footer Start */}
      ...
      {/* Footer Center */}
      <div className="FooterCenter row p-3 ms-2 text-light">
        <div className="col-lg-7">
          <h3>
            Top companies choose{" "}
            <span className="text-primary text-dark fw-semibold">PRO LEARNING</span> to build
      ...
      <div className="FooterEnd container-fluid d-flex">
        <div className="col-lg-2 p-3">
          <p>
            <a href="" className="footerA2 text-dark">
              Udemy Business
            </a>
          </p>
          <p>
            <a href="" className="footerA1 text-dark">
              Teach on Udemy
            </a>
          </p>
          {/* <p><a href='' className='footerA3 text-light'>Get the app</a></p> */}
          <p>
            <a href="" className="footerA4 text-dark">
              About us
            </a>
          </p>
        </div>
        ...
        <div className="col-lg-2 p-3">
          ...
          <p>
            <a href="" className="footerA7 text-dark">
              Blog
            </a>
          </p>
          <p>
            <a href="" className="footerA8 text-dark">
              Help and Support
            </a>
          </p>
          <p>
            <a href="" className="footerA5 text-dark">
              Contact us
            </a>
          </p>
        ...
        <div className="col-lg-2 p-3">
          <p>
            <a href="" className="footerA11 text-dark">
              Terms
            </a>
          </p>
          <p>
            <a href="" className="footerA12 text-dark">
              Privacy policy
            </a>
          </p>
          <p>
            <a href="" className="footerA13 text-dark">
              Cookies settings
            </a>
          </p>
        ...
        <div className="FooterButton2 container-fluid col-lg-2 text-center mt-4 fs-md-2">
          {/* <button
            type="button"
            class="FooterTopButton btn btn-outline-light text-light"
          >
            <FontAwesomeIcon icon={faGlobe} style={{ color: "#ffffff" }} />
            <h5 className="ButtonTitle fs-6 ms-2 p-1">English</h5>
          </button> */}
        </div>
      </div>
